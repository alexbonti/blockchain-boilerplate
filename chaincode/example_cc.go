...
func (t *SimpleChaincode) query(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	// return shim.Success([]byte("oyo!!!"))
}

// Emits a chaincode event
func event(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	stub.SetEvent("test", []byte("hello"))
	return shim.Success(nil)
}

// SetupRouter adds chaincode routes
func (t *SimpleChaincode) SetupRouter() {
	router = invoke.NewRouter()

	router.RegisterHandler("move", t.move)
	router.RegisterHandler("delete", t.delete)
	router.RegisterHandler("query", t.query)
}

func main() {
	var simpleChaincode = new(SimpleChaincode)
	simpleChaincode.SetupRouter()
